...
#undef PREP
    ...
    #define PREP_RECOMPILE_START    if (isNil "dnt_fnc_recompile") then {dnt_recompiles = []; dnt_fnc_recompile = {{call _x} forEach dnt_recompiles;}}; private _recomp = {
    #define PREP_RECOMPILE_END      }; call _recomp; dnt_recompiles pushBack _recomp;
#else
